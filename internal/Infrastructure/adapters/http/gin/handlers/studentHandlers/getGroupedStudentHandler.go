...
type GetGroupedStudentsHandler struct {
	getGroupedUC studentucs.IGroupedStudentsUC
}

func NewGetGroupedStudentsHandler(getGroupedUC studentucs.IGroupedStudentsUC) *GetGroupedStudentsHandler {
	return &GetGroupedStudentsHandler{getGroupedUC}
}
...
func (h *GetGroupedStudentsHandler) GetGroupedStudents(c *gin.Context) {
