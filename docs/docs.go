...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/clienthandlers.%D0%A1reateGroupedClientInputDto"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/clienthandlers.GetGroupedClientsInputDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/clienthandlers.GetGroupedClientsOutputDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "clienthandlers.GetGroupedClientsOutputDTO": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "clienthandlers.СreateGroupedClientInputDto": {
            "type": "object",
            "properties": {
                "client": {
                    "$ref": "#/definitions/dto.ClientCreateUpdateDTO"
        ...
        "dto.ClientGroupCreateUpdateDTO": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "integer"
